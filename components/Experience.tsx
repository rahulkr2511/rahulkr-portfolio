...
export default function Experience() {
  return (
    <section id="experience" className="max-w-content mx-auto px-6 py-20 border-t border-line">
      <TypedLine as="h2" text="$ git log --author=rahul --oneline" className="font-mono text-sm text-mute mb-1" />
      <p className="text-2xl font-mono font-semibold text-paper mb-10">Experience</p>
